  ...
  return (
    <div className="flex flex-col min-h-screen">
      <main className="flex-grow">
        <section className="relative bg-blue-1 text-white py-10 pb-32 rounded-b-[250px]">
        ...
        <section className="pt-10 pb-20 relative" ref={plansSectionRef}>
          <div className="container mx-auto px-4 pb-32">
            ...
            <h2 className="text-3xl font-bold text-center  text-blue-1 mb-12">
          ...
          >
            ...
            {/* <button className="bg-green-1 text-white font-bold py-3 px-6 rounded-[5px] text-md hover:bg-green-2 transition duration-300">
      ...
      <footer className="bg-[#f1f6f4]">
        <div className="max-w-[1070px] w-full text-left py-10 mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-32 mb-16 pl-8 md:pl-16">
            <div>
